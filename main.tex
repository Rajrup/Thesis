...
\title{Enabling Volumetric Video Conferencing and Live Streaming}
...
\committee{Prof.~Ramesh Govindan (Chair)\\*
           Prof.~Harsha V. Madhyastha\\*
           Prof.~Antonio Ortega\\*
           Prof.~Yue Wang\\*
           \\
...
\include{related}
\include{conclusion}
\include{ackowledgement_funding}
