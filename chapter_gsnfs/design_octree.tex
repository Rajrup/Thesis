...
%
To improve compression efficiency, \gsnfs{} then runs a GPU-based entropy encoder (\cref{fig:architecture}), ANS~\cite{nvidia_nvcomp}.
...
%
\cref{app:sysn-octr-decod} contains a detailed listing of this algorithm.
