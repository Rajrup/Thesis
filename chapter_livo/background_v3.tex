...
\end{table}
  ...
  %% \item[Frustum culling:] To reduce point cloud data volume, \livo \textit{culls} points outside the \textit{frustum} (\cref{fig:architecture}, the 3-D equivalent of the \textit{viewport} in 2-D and 360-degree video~\cite{dragonfly}).
  %% %
