...
%
Recent work has explored on-demand and live streaming of volumetric videos (\cref{s:related}, \cref{tab:comparison}). 
...
%
Recent research on volumetric video conferencing either does not support full-scene conferencing or lacks one of these above three properties (\cref{tab:comparison}, \cref{s:related}).
%
...
%
Sender only sends 3D information within the receiver's current field of view.
%
