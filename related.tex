...
Recent work uses learned 3D representation such as Neural Radiance Fields (NeRFs)~\cite{nerf} and Gaussian Splatting (\gs)~\cite{gsplat} for streaming and conferencing.
%
